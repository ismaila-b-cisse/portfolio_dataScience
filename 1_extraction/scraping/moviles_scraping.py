...
async def scroll_and_load(page, n=0):
    ...
    brands_list = ['samsung', 'apple', 'xiaomi', 'blackview', 'reborn', 'oppo', 'google', 'oukitel', 
                   ...
                   'rainbuvvy', 'astarry']
    brands_list = sorted([x.lower() for x in brands_list])
    ...
    products_list_nplus += products_list_n 
    ...
    with open("extracted_data/additional_data/extracted_moviles_data.csv", 'w', newline='', encoding="utf-8") as csvfile:
        ...
        writer.writeheader()
        writer.writerows(products_list_nplus)

    print('================================ Données chargées ================================')
    return products_list_nplus