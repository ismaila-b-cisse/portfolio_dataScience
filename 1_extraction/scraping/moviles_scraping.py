...
""" 
    ...
    Les données extraites sur le site moviles sont des données supplémentaires qui nous permettent de
    mettre en place un référentiel des modèles de marques de mobiles des données déjà extraites,
    sur les sites darty, temu et amazon.
    Ce référentiel nous sera utile dans la préparation de ces données, dans la partie Préparation 
    des données.
"""
